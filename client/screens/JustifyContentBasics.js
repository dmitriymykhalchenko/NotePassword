      ...
      <View style={{ flex: 8, backgroundColor: 'lightgray' }}>
        ...
        //   keyExtractor={this.keyExtractor}
          ...
          {/*// <Interactable.View
            ...
            // >*/}
          <SafeAreaView style={{ position: 'absolute', top: 600, left: 0, zIndex: 1 }}>
            <TouchableOpacity
              style={{ color: 'white', borderTopRightRadius: 10, borderTopLeftRadius: 10, flex: 1 / 3, marginTop: 20, backgroundColor: 'white' }}
              onPress={() => {
            ...
            <SafeAreaView style={{ flex: 1, width: 410, backgroundColor: 'white' }}>
              <Interactable.View
                style={{ zIndex: 1 }}
                ref="blue"
                horizontalOnly={false}
                verticalOnly={false}
                snapPoints={snapPoints}
                initialPosition={{ x: 2, y: 700 }}
              >
                <View style={{ flex: 1, borderRadius: 20, height: 400, backgroundColor: 'white', padding: 20 }}>
                  ...
                  <TextInput
                    ...
                    placeholder="   Website"
                    style={{ flex: 1 / 5, marginTop: 5, borderRadius: 5, borderColor: 'gray', borderWidth: 0.5, backgroundColor: 'rgb(240, 243, 244 )' }}
                    textAlign="left"
                    onChangeText={(site) => {
                  ...
                  <TextInput
                    placeholder="   Login"
                    style={{ flex: 1 / 5, marginTop: 10, borderRadius: 5, borderColor: 'gray', borderWidth: 0.5, backgroundColor: 'rgb(240, 243, 244 )' }}
                    textAlign="left"
                    onChangeText={(log) => {
                      console.log('log-', log)
                      this.setState({ log })
                  ...
                  <TextInput
                    ...
                    style={{ flex: 1 / 5, marginTop: 10, marginBottom: 15, borderRadius: 5, borderColor: 'gray', borderWidth: 0.5, backgroundColor: 'rgb(240, 243, 244 )' }}
                    textAlign="left"
                    onChangeText={(pass) => {
                  ...
                  // return ;}*/}
                  <TouchableOpacity
                    style={{ color: 'white', borderRadius: 10, flex: 1 / 6, marginTop: 20, backgroundColor: 'white' }}
                    onPress={() => {
                  ...
                  >
                    ...
                    <View style={{ color: 'white', borderRadius: 10, flex: 1, backgroundColor: 'rgb(223,240,217)', justifyContent: 'center', flexDirection: 'column' }}>
